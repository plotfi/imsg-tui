...
3) I don't really like the desktop experience for most chat alternatives, for example with with Discord I've started using Discordo (https://github.com/ayn2op/discordo)... I'll probably use steipete's wacli/signal-cli to make similar TUIs someday.
